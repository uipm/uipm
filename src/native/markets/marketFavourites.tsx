...
const MarketFavourites = () => {
  ...
  const [FavouritesDataTable, setFavouritesDataTable] =
    useState(FavouritesData);
                ...
                >
                  <Text
                    style={{
                      ...FONTS.font,
                      color:
                        data.isChecked == true ? COLORS.white : colors.title,
                    }}
                  >
                    {data.title}
                  </Text>
      ...
      >
        <View style={{ paddingHorizontal: 15, width: 800 }}>
          ...
          >
            <Text
              numberOfLines={1}
              style={{ color: colors.title, ...styles.tableItemHead }}
            >
              Name
            </Text>
            <Text
          ...
          {FavouritesDataTable.map((data, index) => {
            return (
              ...
              >
                ...
                <Text
                  numberOfLines={1}
                  style={{ color: colors.text, ...styles.tableItem }}
                >
                  {data.price}
                </Text>
                <Text
