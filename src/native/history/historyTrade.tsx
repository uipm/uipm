...
const HistoryTrade = () => {
  ...
  return (
    <>
      ...
      <View
        style={{ marginBottom: 10, flexDirection: "row", marginHorizontal: 10 }}
      >
        {/* <DatePicker
                    title="From"
                    modal
        ...
        <View style={{ flex: 1, marginRight: 10 }}>
          ...
          >
            ...
            <Text
              style={{ alignSelf: "center", ...FONTS.font, color: colors.text }}
            >
              -
            </Text>
                  ...
                  {item.status === "success" ? (
                    ...
                    <>
                      <FeatherIcon
                        ...
                        name="x-circle"
                      />
                      <Text style={{ ...FONTS.fontXs, color: COLORS.danger }}>
                        failed
                      </Text>
                    </>
                  ) : (
