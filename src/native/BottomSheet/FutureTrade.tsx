...
const FutureTrade = (props) => {
  ...
  return (
    <View style={{ ...GlobalStyleSheet.container }}>
      ...
      <View
        style={{ flexDirection: "row", marginHorizontal: -5, marginBottom: 20 }}
      >
        <View style={{ flex: 1, paddingHorizontal: 5 }}>
          <TouchableOpacity
            ...
            style={[
              styles.tabBtn,
              { backgroundColor: "rgba(111,79,239,.2)" },
              activeTab === "Long" && { backgroundColor: COLORS.primary },
            ]}
          >
            <Text
              style={[
                { ...FONTS.fontLg, ...FONTS.fontMedium, color: COLORS.primary },
                activeTab === "Long" && { color: COLORS.white },
              ]}
            >
              LONG
            </Text>
        ...
        <View style={{ flex: 1, paddingHorizontal: 5 }}>
          <TouchableOpacity
            ...
            style={[
              ...
              activeTab === "Short" && { backgroundColor: COLORS.danger },
            ]}
          >
            <Text
              style={[
                { ...FONTS.fontLg, ...FONTS.fontMedium, color: COLORS.danger },
                activeTab === "Short" && { color: COLORS.white },
              ]}
            >
              SHORT
            </Text>
