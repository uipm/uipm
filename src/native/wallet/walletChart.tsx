...
const WalletChart = () => {
  ...
  const yearData = [
    40, 25, 42, 45, 50, 35, 25, 48, 40, 45, 42, 26, 5, 30, 28, 40, 38, 35, 20,
    38, 40, 50, 35, 20, 45, 35, 28, 40, 20, 42, 20, 25, 40, 35, 20, 45, 35, 28,
    40, 20, 42, 20, 25, 40,
  ];
  const monthData = [
    40, 25, 42, 45, 50, 35, 25, 48, 40, 45, 42, 26, 5, 30, 28, 40, 38, 35, 20,
    38, 40, 50, 35, 20, 45, 35, 28, 40, 20, 42, 20, 25, 40,
  ];
  const weekData = [
    28, 40, 38, 35, 20, 38, 40, 50, 35, 20, 45, 35, 28, 40, 20, 42, 20, 25, 40,
  ];
        ...
        <View style={{ flexDirection: "row" }}>
          {chartTab.map((e, index) => (
            ...
            >
              <Text
                style={[
                  { color: colors.text, ...FONTS.fontXs },
