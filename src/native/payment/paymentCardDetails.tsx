    ...
    <>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        >
          ...
          >
            <Text
              style={{ ...FONTS.h6, color: colors.title, marginRight: "auto" }}
            >
              Card Details
            </Text>
            <Ripple style={{ ...styles.badge, borderColor: COLORS.info }}>
              <Text style={{ ...FONTS.fontXs, color: COLORS.info }}>
                Default
              </Text>
            </Ripple>
            <Ripple style={{ ...styles.badge, borderColor: COLORS.success }}>
              <Text style={{ ...FONTS.fontXs, color: COLORS.success }}>
                Verified
              </Text>
            </Ripple>
          </View>
          ...
          >
            <View style={styles.infoTop}>
              <Ripple style={[styles.radioButton, styles.radioButtonActive]}>
                <Image
                  style={[styles.checkImg, { opacity: 1 }]}
                  source={ICONS.check}
                />
              </Ripple>
              <Image
                style={{ width: 45, height: 24, resizeMode: "contain" }}
                source={IMAGES.visa}
              />
            </View>
            <Text
              style={{ ...FONTS.h6, color: COLORS.white, marginBottom: 12 }}
            >
              ********** 2345
            </Text>
            <View style={styles.infoBottom}>
              <View>
                <Text style={{ ...FONTS.fontXs, ...styles.cardLabel }}>
                  Holder Name
                </Text>
