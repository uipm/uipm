        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          <TouchableOpacity activeOpacity={1}>
            ...
            >
              ...
              <Text
                style={{ ...FONTS.fontXs, color: colors.text, lineHeight: 17 }}
              >
                Please ensure that you deposit and withdraw funds from/to your
                own account only. Deposits and withdrawals from third-party bank
