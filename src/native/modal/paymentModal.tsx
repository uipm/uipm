    ...
    <>
      ...
      <View style={[GlobalStyleSheet.container, { padding: 0 }]}>
        ...
        <View style={{ ...GlobalStyleSheet.modalBody, flex: 1 }}>
          ...
          <View
            style={{ marginTop: 10, marginBottom: 30, marginHorizontal: -20 }}
          >
            <Text
              style={{
                ...FONTS.font,
              ...
              renderItem={({ item }) => (
                <View
                  style={[
                    ...
                    theme.dark && { backgroundColor: "rgba(255,255,255,.1)" },
                  ]}
                >
                  <View style={styles.infoTop}>
                    <Ripple
                      ...
                      style={[
                        styles.radioButton,
                        id === item.id && styles.radioButtonActive,
                      ]}
                    >
                      <Image
                        style={[
                          styles.checkImg,
                          id === item.id && { opacity: 1 },
                        ]}
                        source={ICONS.check}
                      />
                    </Ripple>
